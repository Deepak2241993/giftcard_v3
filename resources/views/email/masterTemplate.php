                        ...
                        <div
                            ...
                            <div style="margin: 20px;">
                                ...
                                <div style="width: 100%; overflow-x: auto; margin: 20px 0;">
                                    ...
                                    @php
                                    $orderdata =
                                    \App\Models\ServiceOrder::where('order_id',
                                    $maildata-&gt;order_id)-&gt;get();
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td
                                                    ...
                                                    ${{
                                                    number_format($ServiceData-&gt;discounted_amount
                                                    ??
                                                    $ServiceData-&gt;amount,
                                                    2) }}
                                                </td>
                                ...
                                @if
                                ($maildata-&gt;gift_card_amount
                                != null)
                                @php
                                $giftamount = explode('|',
                                $maildata-&gt;gift_card_amount);
                                $Totalgiftamount = 0;
                                foreach ($giftamount as
                                $value) {
                                ...
                                <div
                                    ...
                                    === 'product') {
                                    $service =
                                    \App\Models\Product::find($item-&gt;service_id);

                                    $term =
                                    \DB::table('terms')
                                    -&gt;where('status', 1)
                                    -&gt;whereRaw("FIND_IN_SET(?, REPLACE(service_id, '|', ','))",
                                    [$item-&gt;service_id])
                                    -&gt;first();
                                    ...
                                    === 'unit') {
                                    $service =
                                    \App\Models\ServiceUnit::find($item-&gt;service_id);

                                    $term =
                                    \DB::table('terms')
                                    -&gt;where('status', 1)
                                    -&gt;whereRaw("FIND_IN_SET(?, REPLACE(unit_id, '|', ','))",
                                    [$item-&gt;service_id])
                                    -&gt;first();
                                    ...
                                    <tr>
                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:40px 10px 10px;font-family:arial,helvetica,sans-serif;"
                                            ...
                                            <div class="v-line-height v-font-size"
                                                ...
                                                <p style="line-height: 130%;">At
                                                    My Forever MedSpa, we believe that every special occasion deserves to
                                                </p>
                                                <p style="line-height: 130%;">be
                                                    celebrated in style. Whether it's a birthday, anniversary,
                                                </p>
                                                <p style="line-height: 130%;">or
                                                    just a "just because" moment, we're here to make it unforgettable.
                                                </p>
                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:30px 10px;font-family:arial,helvetica,sans-serif;"
                                            ...
                                            <div align="center">
                                                            ...
                                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:20px 50px 10px;font-family:arial,helvetica,sans-serif;"
                                                                ...
                                                                <div class="v-line-height v-font-size"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        @if
                                                                        (!empty($template_data[0]['footer_message']))
                                                                        {{
                                                                                ...
                                                                                <tr
                                                                                    ...
                                                                                    <td align="left"
                                                                                        ...
                                                                                        <a href="https://forevermedspanj.com/"
                                                                                            title="Website"
                                                                                            target="_blank">
                                                                                            <img src="{{ url('/') }}/email_template/globe.png" alt="Twitter" title="Twitter" width="32" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 32px !important" onerror="this.onerror=null; this.src='{{url('/No_Image_Available.jpg')}}';">
                                                                                        </a>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                ...
                                                <p> Have
                                                    ...
                                                    Call or
                                                    text us
                                                    at <a href="tel:+12013404809">(201)&nbsp;340‑4809</a> and our team will be happy to assist you.</p>
                                                <p>
                                                    <a href="https://forevermedspanj.com/services/book-appointments/"
                                                        target="_blank" style="display:inline-block; padding:12px 28px; background:#fca52a; color:#ffffff; font-family:Arial, sans-serif; font-size:16px; font-weight:600; text-decoration:none; border-radius:30px; box-shadow:0 4px 10px rgba(0,0,0,0.2); letter-spacing:0.5px; margin-top:20px;"> Book your Appointment
                                                    </a>
                                                </p>
                                        ...
                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:60px 50px 20px;font-family:arial,helvetica,sans-serif;"
                                            ...
                                            <div class="v-line-height v-font-size"
                                                ...
                                                <p style="font-size: 18px; line-height: 140%;">Forever
                                                    Medspa Forever Medspa.<br> 468 Paterson Ave East Rutherford NJ, 07073<br> ©{{ date('Y') }} All rights reserved.
                                                </p>
                                            </div>
                                        </td>
                                    </tr>
