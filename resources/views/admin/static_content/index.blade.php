                        ...
                        {{-- <div class="scroll-content"> --}}
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="sorting sorting_asc" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Title">Page Name</th>
                                    <th class="sorting sorting_asc" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Image">Title</th>
                                    <th class="sorting sorting_asc" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" aria-sort="ascending" aria-label="URL">Content</th>
                            ...
                            <tbody>
                                @foreach($data as $key=>$value)
                                    <tr>
                                        ...
                                        <td>{{ $value->page_name ? $value->page_name : '' }}</td>
                                        <td>{{ $value->title ? $value->title : '' }}</td>
                                        
                                        <td>{{ substr($value->content, 0, 10) }}</td>
