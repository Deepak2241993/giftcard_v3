        ...
        <tbody>
            <tr style="vertical-align: top">
                <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                    ...
                    <!-- Header Section -->
                    {{-- {{ dd($maildata->result[1]['giftnumber']) }} --}}
                    <!-- Body Section -->
                    <div class="u-row-container" style="padding: 0px;background-color: transparent">
                        <div class="u-row"
                            style="margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: transparent;">
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            @switch($template->id)
                                                ...
                                                @case(8)
                                                    @include('email.include.giftcardPurchaseOther')
                                                @break

                                                @case(9)
                                                    @include('email.include.giftcardPurchaseRecipt')
                                                @break

                                                @case(10)
                                                    @include('email.include.giftcardCancel')
                                                @break
                                                    @case(11)
                                                    @include('email.include.giftcardPurchaseSelf')
                                                @break
                                                    @case(12)
                                            ...
                                            start --}}
                                                                                                ...
                                                                                                <tr
                                                                                                    ...
                                                                                                    <td align="left"
                                                                                                        ...
                                                                                                        <a href="{{ $template->social_media_1_url }}"
                                                                                                            title="Website"
                                                                                                            target="_blank">
                                                                                                            <img src={{ $template->social_media_1 }}
                                                                                                                width="32"
                                                                ...
                                                                <p>
                                                                    <a href="{{ $template->button_link }}"
                                                                        target="_blank"
                                                                        style="display:inline-block; padding:12px 28px; background:#fca52a; color:#ffffff; font-family:Arial, sans-serif; font-size:16px; font-weight:600; text-decoration:none; border-radius:30px; box-shadow:0 4px 10px rgba(0,0,0,0.2); letter-spacing:0.5px; margin-top:20px;">
