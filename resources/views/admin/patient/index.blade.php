            ...
            <div class="modal-content">
                ...
                <div class="modal-header bg-warning d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        ...
                        <button id="swapPatientsBtn" type="button" class="btn btn-outline-dark btn-sm">
                            🔄 Swap KEEP / MERGE
                        </button>
                ...
                <div class="modal-footer">
                    <button id="confirmMergeBtn" type="button" class="btn btn-danger">
                        Proceed
                    </button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="text" id="mergeConfirmText" class="form-control" placeholder="Type MERGE">
                </div>

                <div class="modal-footer">
                    <button id="finalMergeBtn" type="button" class="btn btn-danger" disabled>
                        🔥 MERGE
                    </button>
